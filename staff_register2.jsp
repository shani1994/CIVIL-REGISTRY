...
<%
    ...
    String name="";
            ...
            String emailid="";
            String quali="";
            String dept=session.getAttribute("did").toString();      
            String filename="";
    ...
    while(iter.hasNext()){
        ...
        if(item.isFormField()){
            ...
            st.executeUpdate("insert into login values(null,'"+emailid+"','"+pass+"','staff')", Statement.RETURN_GENERATED_KEYS);
            String id="";
            ...
            if(rs.next())
            {
              ...
              st.executeUpdate("insert into staff_reg values(null,'"+dept+"','"+name+"','"+dob+"','"+gen+"','"+ftname+"','"+mtname+"','"+hname+"','"+place+"','"+post+"','"+dist+"','"+phno+"','"+pin+"','"+emailid+"','"+quali+"','"+filename+"','"+id+"','staff')");
